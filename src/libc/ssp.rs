...
// Если защита стека поймает переполнение
// (буфер оверфлоу), игра вызовет эту
// На реальном iOS этот вызов аборт-ит
// гостевой процесс, а не хост. Чтобы не
// возвращаемся: пусть гость продолжит
// работу до следующей фатальной ошибки
...
pub const FUNCTIONS: FunctionExports = &[
    // Экспортируем функцию. Макрос
    // автоматически добавит нужное
    // подчеркивание
];

pub const CONSTANTS: ConstantExports = &[
    // Используем гарантированно
