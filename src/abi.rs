...
//! Useful resources:
//!
//! * Apple's [Writing ARMv6 code for
//iOS](https://developer.apple.com/documentation/xcode/writing-armv6-code-for-ios),
//read together with Arm's [Procedure Call Standard for the Arm Architecture
